...
public class EncryptUtils {
     ...
     * @return 
     */  
    public static String encryptPBKDF2(String msg,String salts) {  
        try {  
            int iterations = 1000;  
...
//        System.out.println(EncryptUtils.encryptSalt("guuadmin","00001"));  
//        System.out.println(EncryptUtils.encryptSalt("sdfs","00001"));  
//        System.out.println(EncryptUtils.encryptSHA("123456"));  
//        System.out.println(EncryptUtils.encryptPBKDF2("123456","guu1"));  
//    }  
}
